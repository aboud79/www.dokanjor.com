!(function () {
  ...
  class s {
    ...
    _loadLight(e) {
      ...
      switch (o.type) {
        case "directional":
          (a = new THREE.DirectionalLight(i)).target.position.set(0, 0, -1),
            a.add(a.target);
          break;
        case "point":
          ...
          break;
        case "spot":
          ((a = new THREE.SpotLight(i)).distance = l),
            (o.spot = o.spot || {}),
    ...
    extendParams(e, t, s) {
      ...
      if (r) {
        ...
        void 0 !== r.baseColorTexture &&
          n.push(s.assignTexture(e, "map", r.baseColorTexture));
      }
    ...
    extendParams(e, t, s) {
      ...
      if (
        (void 0 !== n.diffuseTexture &&
          r.push(s.assignTexture(e, "map", n.diffuseTexture)),
        ...
        r.push(s.assignTexture(e, "glossinessMap", t)),
          r.push(s.assignTexture(e, "specularMap", t));
      }
      return Promise.all(r);
    }
    createMaterial(e) {
  ...
  (T.prototype.beforeStart_ = T.prototype.copySampleValue_),
    ...
    (T.prototype.interpolate_ = function (e, t, s, n) {
  ...
  const R = {
    ...
    S = { SCALAR: 1, VEC2: 2, VEC3: 3, VEC4: 4, MAT2: 4, MAT3: 9, MAT4: 16 },
    A = {
      POSITION: "position",
      NORMAL: "normal",
      TANGENT: "tangent",
    ...
    _ = { OPAQUE: "OPAQUE", MASK: "MASK", BLEND: "BLEND" };
  function H(e, t) {
  ...
  function N(e) {
    ...
    let n;
    return (n = s
      ? "draco:" + s.bufferView + ":" + s.indices + ":" + P(s.attributes)
      : e.indices + ":" + P(e.attributes) + ":" + e.mode);
  }
  function P(e) {
    let t = "";
  ...
  class C {
      ...
      return (
        ...
        Promise.all(r).then(function (e) {
          ...
          if (u && u !== l) {
            ...
            let l = t.cache.get(s);
            l ||
              ((p = new a(r, e * u, (n.count * u) / i)),
              (l = new THREE.InterleavedBuffer(p, u / i)),
              t.cache.add(s, l)),
              (d = new THREE.InterleavedBufferAttribute(l, o, (c % u) / i, h));
    ...
    loadTextureImage(e, t, s) {
      ...
      if (
        (("image/jpeg" === t.mimeType || p) && (h = !1),
        void 0 !== t.bufferView)
      )
        c = n.getDependency("bufferView", t.bufferView).then(function (e) {
      ...
      const d = Promise.resolve(c)
        ...
        .then(function (t) {
          !0 === u && l.revokeObjectURL(c),
            ...
            h || (t.format = THREE.RGBFormat);
          const s = (r.samplers || {})[a.sampler] || {};
          return (
            (t.magFilter = M[s.magFilter] || THREE.LinearFilter),
            (t.minFilter = M[s.minFilter] || THREE.LinearMipmapLinearFilter),
            (t.wrapS = v[s.wrapS] || THREE.RepeatWrapping),
            (t.wrapT = v[s.wrapT] || THREE.RepeatWrapping),
            n.associations.set(t, { type: "textures", index: e }),
            t
          );
        })
        .catch(function () {
      ...
      return this.getDependency("texture", n.index).then(function (o) {
        if (
          ...
          if (e) {
            ...
            (o = r.extensions[t.KHR_TEXTURE_TRANSFORM].extendTexture(o, e)),
              r.associations.set(o, s);
          }
        }
        e[s] = o;
      });
    ...
    loadMaterial(e) {
      ...
      if (l[t.KHR_MATERIALS_PBR_SPECULAR_GLOSSINESS]) {
        ...
        void 0 !== t.baseColorTexture &&
          c.push(s.assignTexture(i, "map", t.baseColorTexture)),
          (i.metalness = void 0 !== t.metallicFactor ? t.metallicFactor : 1),
          (i.roughness = void 0 !== t.roughnessFactor ? t.roughnessFactor : 1),
          void 0 !== t.metallicRoughnessTexture &&
            (c.push(
              s.assignTexture(i, "metalnessMap", t.metallicRoughnessTexture)
            ),
            c.push(
              s.assignTexture(i, "roughnessMap", t.metallicRoughnessTexture)
            )),
      ...
      return (
        u === _.BLEND
          ? ((i.transparent = !0), (i.depthWrite = !1))
          : ((i.transparent = !1),
            u === _.MASK &&
              (i.alphaTest = void 0 !== o.alphaCutoff ? o.alphaCutoff : 0.5)),
        void 0 !== o.normalTexture &&
          a !== THREE.MeshBasicMaterial &&
          (c.push(s.assignTexture(i, "normalMap", o.normalTexture)),
          (i.normalScale = new THREE.Vector2(1, -1)),
          void 0 !== o.normalTexture.scale &&
            i.normalScale.set(o.normalTexture.scale, -o.normalTexture.scale)),
        void 0 !== o.occlusionTexture &&
          a !== THREE.MeshBasicMaterial &&
          (c.push(s.assignTexture(i, "aoMap", o.occlusionTexture)),
          void 0 !== o.occlusionTexture.strength &&
            (i.aoMapIntensity = o.occlusionTexture.strength)),
        void 0 !== o.emissiveFactor &&
          a !== THREE.MeshBasicMaterial &&
          (i.emissive = new THREE.Color().fromArray(o.emissiveFactor)),
        void 0 !== o.emissiveTexture &&
          a !== THREE.MeshBasicMaterial &&
          c.push(s.assignTexture(i, "emissiveMap", o.emissiveTexture)),
        Promise.all(c).then(function () {
          let n;
          return (
            (n =
              a === f
                ? r[t.KHR_MATERIALS_PBR_SPECULAR_GLOSSINESS].createMaterial(i)
                : new a(i)),
            o.name && (n.name = o.name),
            n.map && (n.map.encoding = THREE.sRGBEncoding),
            n.emissiveMap && (n.emissiveMap.encoding = THREE.sRGBEncoding),
            b(n, o),
            s.associations.set(n, { type: "materials", index: e }),
            o.extensions && w(r, n, o),
            n
          );
        })
      );
    ...
    loadGeometries(e) {
      ...
      for (let n = 0, i = e.length; n < i; n++) {
        ...
        if (c) a.push(c.promise);
          ...
          let e;
          (e =
            i.extensions && i.extensions[t.KHR_DRACO_MESH_COMPRESSION]
              ? o(i)
              : U(new THREE.BufferGeometry(), i, s)),
            (r[l] = { primitive: i, promise: e }),
            a.push(e);
        }
      }
    ...
    loadMesh(e) {
      ...
      for (let e = 0, t = o.length; e < t; e++) {
        const t =
          void 0 === o[e].material
            ? (void 0 === (i = this.cache).DefaultMaterial &&
      ...
      return (
        ...
        Promise.all(a).then(function (s) {
          ...
          for (let s = 0, c = i.length; s < c; s++) {
            ...
            if (
              u.mode === R.TRIANGLES ||
              u.mode === R.TRIANGLE_STRIP ||
              u.mode === R.TRIANGLE_FAN ||
              void 0 === u.mode
            )
              !0 !==
                (h =
                ...
                u.mode === R.TRIANGLE_STRIP
                  ? (h.geometry = D(h.geometry, THREE.TriangleStripDrawMode))
                  : u.mode === R.TRIANGLE_FAN &&
                    (h.geometry = D(h.geometry, THREE.TriangleFanDrawMode));
            ...
            Object.keys(h.geometry.morphAttributes).length > 0 && I(h, r),
              (h.name = t.createUniqueName(r.name || "mesh_" + e)),
              b(h, r),
              u.extensions && w(n, h, u),
    ...
    loadNode(e) {
      ...
      return (function () {
        ...
        if (
          (r.name && ((a.userData.name = r.name), (a.name = o)),
          b(a, r),
          r.extensions && w(s, a, r),
          void 0 !== r.matrix)
        ) {
        ...
        return n.associations.set(a, { type: "nodes", index: e }), a;
      });
    }
    loadScene(e) {
      const t = this.json,
