    ...
    constructor(o, a) {
      super(),
        ...
        (this.update = (function () {
          ...
          return function () {
            ...
            t.copy(o).sub(i.target),
              ...
              i.autoRotate &&
                r === c.NONE &&
                w(((2 * Math.PI) / 60 / 60) * i.autoRotateSpeed),
              i.enableDamping
                ? ((l.theta += m.theta * i.dampingFactor),
                  (l.phi += m.phi * i.dampingFactor))
                : ((l.theta += m.theta), (l.phi += m.phi));
            let T = i.minAzimuthAngle,
              O = i.maxAzimuthAngle;
            return (
              isFinite(T) &&
                isFinite(O) &&
                (T < -Math.PI ? (T += b) : T > Math.PI && (T -= b),
                O < -Math.PI ? (O += b) : O > Math.PI && (O -= b),
                (l.theta =
                  T <= O
                    ? Math.max(T, Math.min(O, l.theta))
                    : l.theta > (T + O) / 2
                    ? Math.max(T, l.theta)
                    : Math.min(O, l.theta))),
              (l.phi = Math.max(
                i.minPolarAngle,
                Math.min(i.maxPolarAngle, l.phi)
              )),
              l.makeSafe(),
              (l.radius *= u),
              (l.radius = Math.max(
                i.minDistance,
                Math.min(i.maxDistance, l.radius)
              )),
              !0 === i.enableDamping
                ? i.target.addScaledVector(E, i.dampingFactor)
                : i.target.add(E),
              ...
              !0 === i.enableDamping
                ? ((m.theta *= 1 - i.dampingFactor),
                  (m.phi *= 1 - i.dampingFactor),
                  E.multiplyScalar(1 - i.dampingFactor))
                : (m.set(0, 0, 0), E.set(0, 0, 0)),
              (u = 1),
              !!(
                p ||
                h.distanceToSquared(i.object.position) > s ||
                8 * (1 - d.dot(i.object.quaternion)) > s
              ) &&
                (i.dispatchEvent(e),
        ...
        (this.dispose = function () {
          i.domElement.removeEventListener("contextmenu", B),
            i.domElement.removeEventListener("pointerdown", _),
            i.domElement.removeEventListener("pointercancel", X),
            i.domElement.removeEventListener("wheel", Z),
            i.domElement.ownerDocument.removeEventListener("pointermove", z),
            i.domElement.ownerDocument.removeEventListener("pointerup", F),
      ...
      const L = (function () {
          const e = new THREE.Vector3();
          return function (t, n) {
            e.setFromMatrixColumn(n, 0), e.multiplyScalar(-t), E.add(e);
          };
        })(),
        N = (function () {
          const e = new THREE.Vector3();
        ...
        M = (function () {
          ...
          return function (t, n) {
            ...
            if (i.object.isPerspectiveCamera) {
              ...
              let c = e.length();
              (c *= Math.tan(((i.object.fov / 2) * Math.PI) / 180)),
                L((2 * t * c) / o.clientHeight, i.object.matrix),
                N((2 * n * c) / o.clientHeight, i.object.matrix);
            } else
      ...
      function Y() {
        if (1 === y.length) h.set(y[0].pageX, y[0].pageY);
          ...
          const e = 0.5 * (y[0].pageX + y[1].pageX),
            t = 0.5 * (y[0].pageY + y[1].pageY);
          h.set(e, t);
        }
      }
      function x() {
        if (1 === y.length) T.set(y[0].pageX, y[0].pageY);
        else {
          const e = 0.5 * (y[0].pageX + y[1].pageX),
            t = 0.5 * (y[0].pageY + y[1].pageY);
          T.set(e, t);
      ...
      function U(e) {
        ...
        b.subVectors(d, h).multiplyScalar(i.rotateSpeed);
        const t = i.domElement;
        w((2 * Math.PI * b.x) / t.clientHeight),
          v((2 * Math.PI * b.y) / t.clientHeight),
          h.copy(d);
      }
      function I(e) {
        if (1 === y.length) O.set(e.pageX, e.pageY);
        else {
          const t = q(e),
            n = 0.5 * (e.pageX + t.x),
            o = 0.5 * (e.pageY + t.y);
        ...
        f.subVectors(O, T).multiplyScalar(i.panSpeed), M(f.x, f.y), T.copy(O);
      }
      function V(e) {
        const t = q(e),
          n = e.pageX - t.x,
          ...
          a = Math.sqrt(n * n + o * o);
        R.set(0, a),
          H.set(0, Math.pow(R.y / g.y, i.zoomSpeed)),
          j(H.y),
          g.copy(R);
      }
      function _(e) {
        !1 !== i.enabled &&
          (0 === y.length &&
            (i.domElement.ownerDocument.addEventListener("pointermove", z),
            i.domElement.ownerDocument.addEventListener("pointerup", F)),
          (function (e) {
            y.push(e);
          })(e),
          "touch" === e.pointerType
            ...
            ? (function (e) {
                switch ((W(e), r)) {
                  ...
                  case c.TOUCH_DOLLY_PAN:
                    if (!1 === i.enableZoom && !1 === i.enablePan) return;
                    !(function (e) {
                      i.enableZoom && V(e), i.enablePan && I(e);
                    })(e),
                      i.update();
                    break;
                  case c.TOUCH_DOLLY_ROTATE:
                    ...
                    !(function (e) {
                      i.enableZoom && V(e), i.enableRotate && U(e);
                    })(e),
                      i.update();
                    break;
                  default:
                  ...
                  case c.PAN:
                    ...
                    !(function (e) {
                      O.set(e.clientX, e.clientY),
                        f.subVectors(O, T).multiplyScalar(i.panSpeed),
                        M(f.x, f.y),
                        T.copy(O),
                        i.update();
                    })(e);
      ...
      function Z(e) {
        !1 === i.enabled ||
          ...
          i.dispatchEvent(t),
          (function (e) {
            e.deltaY < 0 ? S(A()) : e.deltaY > 0 && j(A()), i.update();
          })(e),
          i.dispatchEvent(n));
      }
      function K(e) {
        !1 !== i.enabled &&
          ...
          (function (e) {
            ...
            switch (e.code) {
              case i.keys.UP:
                M(0, i.keyPanSpeed), (t = !0);
                break;
              case i.keys.BOTTOM:
                M(0, -i.keyPanSpeed), (t = !0);
                break;
              case i.keys.LEFT:
                M(i.keyPanSpeed, 0), (t = !0);
                break;
              case i.keys.RIGHT:
                M(-i.keyPanSpeed, 0), (t = !0);
            }
      ...
      function W(e) {
        let t = P[e.pointerId];
        void 0 === t && ((t = new THREE.Vector2()), (P[e.pointerId] = t)),
      ...
      i.domElement.addEventListener("contextmenu", B),
        i.domElement.addEventListener("pointerdown", _),
        i.domElement.addEventListener("pointercancel", X),
        i.domElement.addEventListener("wheel", Z, { passive: !1 }),
        this.update();
    }
  }
  (THREE.MapControls = class extends o {
    constructor(e, t) {
      super(e, t),
